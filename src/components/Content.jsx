...
function Content(){
    ...
    return(
        <div className="flex content-wrapper ">
            ...
            <button className="btn-primary bg-[#1F5AA6] p-3 rounded-4xl font-bold mr-6 text-gray-50 border-2 border-gray-300 cursor-pointer" onClick={() => navigate('studentlist')}>
                Open Student  list <i className="fa-solid fa-graduation-cap"></i></button>
            <button className="btn-secondary font-bold text-[#1F5AA6] hover:bg-[#1F5AA6] p-3 rounded-4xl hover:text-gray-50 border-2 border-gray-300 cursor-pointer" onClick={() => navigate('favouritestudent')}>
